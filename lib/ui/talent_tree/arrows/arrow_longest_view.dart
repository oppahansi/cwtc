...
class ArrowLongestView extends StatelessWidget {
  final Talent talent;
  final Talent dependee;

  const ArrowLongestView({
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<ArrowViewModel>.reactive(
      builder: (context, model, child) {
        ...
        double height = SizeConfig.safeBlockHorizontal! * 72.5;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.contain,
                  image: AssetImage(model.getArrowLongestImage),
